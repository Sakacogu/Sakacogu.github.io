(()=>{
    var P = ()=>navigator.vendor === "Google Inc." || navigator.agent === "Edg/", E = ()=>typeof ImageDecoder > "u" ? !1 : P(), L = ()=>typeof Intl.v8BreakIterator < "u" && typeof Intl.Segmenter < "u", W = ()=>{
        let n = [
            0,
            97,
            115,
    ...
    var v = class {
        ...
        async load(t, i, r, e, a) {
            ...
            {
                let o = t.mainJsPath ?? "main.dart.js", c = l(s, o);
        ...
        async _loadWasmEntrypoint(t, i, r, e) {
            if (!this._scriptLoaded) {
                ...
                let { mainWasmPath: a, jsSupportRuntimePath: s } = t, o = l(r, a), c = l(r, s);
...
Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`), Promise.reject(new Error(o));
            ...
            let { serviceWorkerVersion: i, serviceWorkerUrl: r = l(`flutter_service_worker.js?v=${i}`), timeoutMillis: e = 4e3 } = t, a = r;
        ...
        constructor(t, i = "flutter-js"){
            ...
            window.trustedTypes && (this.policy = trustedTypes.createPolicy(i, {
                createScriptURL: function(e) {
                    ...
                    let a = new URL(e, window.location), s = a.pathname.split("/").pop();
    ...
    var k = (n)=>{
        ...
        return (i, r)=>((async ()=>{
                let e = await t, a = await WebAssembly.instantiate(e, i);
                r(a, e);
            })(), {});
    };
    ...
    var S = class {
        async loadEntrypoint(t) {
            let { serviceWorker: i, ...r } = t || {}, e = new g, a = new y;
        ...
        async load({ serviceWorkerSettings: t, onEntrypointLoaded: i, nonce: r, config: e } = {}) {
            ...
            }, c = (u)=>u.compileTarget === "dart2wasm" && !w.supportsWasmGC || e.renderer && !o(u, e.renderer) ? !1 : s(u.renderer), p = a.builds.find(c);
...
_flutter.loader.load({
    serviceWorkerSettings: {
        serviceWorkerVersion: "1379447303"
    }
});

//# sourceMappingURL=web.76646dee.js.map
