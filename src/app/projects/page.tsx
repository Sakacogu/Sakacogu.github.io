...
const allProjects: Project[] = [
  ...
  {
    title: 'Cocktail API!',
    description: 'An easy to use site for cocktail recipes!',
      ...
      <div className="flex flex-col gap-12 items-center">
        {projects.map((proj, idx) => (
          <motion.div
            key={idx}
            className={`
              w-full max-w-6xl p-4 rounded-xl
              bg-gradient-to-br
              ${dark ? 'from-red-600 to-black/50' : 'from-blue-600 to-purple-700'}
          ...
          >
            ...
            {/* preview iframe only on sm+ */}
            <div className="hidden sm:block w-full aspect-video rounded-lg overflow-hidden mb-4 border border-white/40">
              <iframe
                src={proj.preview}
